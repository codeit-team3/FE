...
function BookClubDetailPage({}) {
  return (
    <div className="flex w-full flex-col gap-4 p-4 pb-[120px]">
      {/* 이미지 영역 */}
      ...
      <div className="flex flex-col gap-2.5 border-y-2 border-gray-200 bg-white p-6">
        <div className="flex items-center gap-5">
          <div className="gpa-2 flex flex-col items-center justify-center gap-2">
